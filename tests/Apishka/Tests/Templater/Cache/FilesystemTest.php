...
class Apishka_Tests_Templater_Cache_FilesystemTest extends PHPUnit_Framework_TestCase
{
    private $classname;
    private $directory;
    private $cache;
    ...
    protected function setUp()
    {
        ...
        $this->classname = '__Apishka_Tests_Templater_Cache_FilesystemTest_Template_' . $nonce;
    ...
    protected function tearDown()
    {
        if (file_exists($this->directory)) {
            Apishka_Tests_Templater_FilesystemHelper::removeDir($this->directory);
        }
    }
