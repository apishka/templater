...
class Apishka_Tests_Templater_Node_Expression_CallTest extends PHPUnit_Framework_TestCase
{
    public function testGetArguments()
    {
        $node = new Apishka_Tests_Templater_Node_Expression_Call(array(), array('type' => 'function', 'name' => 'date'));
    ...
    public function testResolveArgumentsWithMissingValueForOptionalArgument()
    {
        ...
        $node = new Apishka_Tests_Templater_Node_Expression_Call(array(), array('type' => 'function', 'name' => 'substr_compare'));
    ...
    {
        $node = new Apishka_Tests_Templater_Node_Expression_Call(array(), array('type' => 'function', 'name' => 'custom_function'));
    ...
    {
        $node = new Apishka_Tests_Templater_Node_Expression_Call(array(), array('type' => 'function', 'name' => 'custom_static_function'));
        $this->assertEquals(array('arg1'), $this->getArguments($node, array(__CLASS__ . '::customStaticFunction', array('arg1' => 'arg1'))));
    }

    /**
     * @expectedException        LogicException
     * @expectedExceptionMessage The last parameter of "Apishka_Tests_Templater_Node_Expression_CallTest::customFunctionWithArbitraryArguments" for function "foo" must be an array with default value, eg. "array $arg = array()".
     */
    public function testResolveArgumentsWithMissingParameterForArbitraryArguments()
    {
        $node = new Apishka_Tests_Templater_Node_Expression_Call(array(), array('type' => 'function', 'name' => 'foo', 'is_variadic' => true));
...
class Apishka_Tests_Templater_Node_Expression_Call extends Apishka_Templater_Node_Expression_CallAbstract
{
}
