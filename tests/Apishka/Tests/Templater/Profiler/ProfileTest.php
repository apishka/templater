...
class Apishka_Tests_Templater_Profiler_ProfileTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $profile = new Apishka_Templater_Profiler_Profile('template', Apishka_Templater_Profiler_Profile::ROOT);
        $this->assertTrue($profile->isRoot());

        $profile = new Apishka_Templater_Profiler_Profile('template', Apishka_Templater_Profiler_Profile::TEMPLATE);
    ...
    {
        $profile = new Apishka_Templater_Profiler_Profile('template', Apishka_Templater_Profiler_Profile::BLOCK);
    ...
    {
        $profile = new Apishka_Templater_Profiler_Profile('template', Apishka_Templater_Profiler_Profile::MACRO);
    ...
    public function testGetAddProfile()
    {
        ...
        $profile->addProfile($a = new Apishka_Templater_Profiler_Profile());
        $profile->addProfile($b = new Apishka_Templater_Profiler_Profile());
