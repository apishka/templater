...
class Apishka_Tests_Templater_Profiler_Dumper_BlackfireTest extends Apishka_Tests_Templater_Profiler_Dumper_AbstractTest
{
    public function testDump()
    {
        $dumper = new Apishka_Templater_Profiler_Dumper_Blackfire();
