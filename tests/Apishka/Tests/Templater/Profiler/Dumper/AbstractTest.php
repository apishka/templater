...
abstract class Apishka_Tests_Templater_Profiler_Dumper_AbstractTest extends PHPUnit_Framework_TestCase
{
    protected function getProfile()
    {
        $profile = $this->getMockBuilder('Apishka_Templater_Profiler_Profile')->disableOriginalConstructor()->getMock();
     ...
     *
     * @return Apishka_Templater_Profiler_Profile
     */
