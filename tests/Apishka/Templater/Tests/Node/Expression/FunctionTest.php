...
class Apishka_Templater_Tests_Node_Expression_FunctionTest extends Apishka_Templater_Test_NodeTestCase
{
    public function testConstructor()
    {
        $name = 'function';
        $args = new Apishka_Templater_Node();
        $node = new Apishka_Templater_Node_Expression_Function($name, $args, 1);
    ...
    public function getTests()
    {
        ...
        $node = $this->createFunction('foo', array(new Apishka_Templater_Node_Expression_Constant('bar', 1), new Apishka_Templater_Node_Expression_Constant('foobar', 1)));
        ...
        $node = $this->createFunction('bar', array(new Apishka_Templater_Node_Expression_Constant('bar', 1)));
        ...
        $node = $this->createFunction('foofoo', array(new Apishka_Templater_Node_Expression_Constant('bar', 1)));
        ...
        $node = $this->createFunction('foobar', array(new Apishka_Templater_Node_Expression_Constant('bar', 1)));
        ...
        $node = $this->createFunction('barbar', array('foo' => new Apishka_Templater_Node_Expression_Constant('bar', 1)));
        $tests[] = array($node, 'twig_tests_function_barbar(null, null, array("foo" => "bar"))', $environment);

        $node = $this->createFunction('barbar', array('arg2' => new Apishka_Templater_Node_Expression_Constant('bar', 1)));
        ...
        $node = $this->createFunction('anonymous', array(new Apishka_Templater_Node_Expression_Constant('foo', 1)));
    ...
    {
        return new Apishka_Templater_Node_Expression_Function($name, new Apishka_Templater_Node($arguments), 1);
    }
