...
class Apishka_Templater_Tests_Node_ImportTest extends Apishka_Templater_Test_NodeTestCase
{
    ...
    {
        $macro = new Apishka_Templater_Node_Expression_Constant('foo.twig', 1);
        $var = new Apishka_Templater_Node_Expression_AssignName('macro', 1);
        $node = new Apishka_Templater_Node_Import($macro, $var, 1);
