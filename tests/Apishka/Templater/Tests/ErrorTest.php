...
class Apishka_Templater_Tests_ErrorTest extends PHPUnit_Framework_TestCase
{
    public function testErrorWithObjectFilename()
    {
        ...
        $this->assertContains('tests' . DIRECTORY_SEPARATOR . 'Apishka' . DIRECTORY_SEPARATOR .  'Templater' . DIRECTORY_SEPARATOR . 'Tests' . DIRECTORY_SEPARATOR . 'ErrorTest.php', $error->getMessage());
    }
    ...
    {
        $loader = new Apishka_Templater_Loader_Filesystem(__DIR__ . '/Fixtures/errors');
        $twig = new Apishka_Templater_Environment($loader, array('strict_variables' => true, 'debug' => true, 'cache' => false));
        ...
        try {
            $template->render(array('foo' => new Apishka_Templater_Tests_ErrorTest_Foo()));
    ...
    {
        $loader = new Apishka_Templater_Loader_Array($templates);
        $twig = new Apishka_Templater_Environment($loader, array('strict_variables' => true, 'debug' => true, 'cache' => false));
...
class Apishka_Templater_Tests_ErrorTest_Foo
{
    public function bar()
    {
