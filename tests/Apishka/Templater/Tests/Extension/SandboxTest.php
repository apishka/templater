...
class Apishka_Templater_Tests_Extension_SandboxTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException        Apishka_Templater_Sandbox_SecurityError
...
EOF
    ...
    protected function getEnvironment($sandboxed, $options, $templates, $tags = array(), $filters = array(), $methods = array(), $properties = array(), $functions = array())
    {
        ...
        $twig = new Apishka_Templater_Environment($loader, array_merge(array('debug' => true, 'cache' => false, 'autoescape' => false), $options));
        $policy = new Apishka_Templater_Sandbox_SecurityPolicy($tags, $filters, $methods, $properties, $functions);
        $twig->addExtension(new Apishka_Templater_Extension_Sandbox($policy, $sandboxed));
