...
class Apishka_Templater_Tests_Extension_CoreTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testRandomFunctionWithoutParameter()
    {
        ...
        for ($i = 0; $i < 100; ++$i) {
            $val = twig_random(new Apishka_Templater_Environment($this->getMock('Apishka_Templater_LoaderInterface')));
    ...
    {
        $this->assertSame('', twig_random(new Apishka_Templater_Environment($this->getMock('Apishka_Templater_LoaderInterface')), ''));
        $this->assertSame('', twig_random(new Apishka_Templater_Environment($this->getMock('Apishka_Templater_LoaderInterface'), array('charset' => null)), ''));

        $instance = new stdClass();
        $this->assertSame($instance, twig_random(new Apishka_Templater_Environment($this->getMock('Apishka_Templater_LoaderInterface')), $instance));
    }
    ...
    {
        twig_random(new Apishka_Templater_Environment($this->getMock('Apishka_Templater_LoaderInterface')), array());
    }
    ...
    {
        twig_escape_filter(new Apishka_Templater_Environment($this->getMock('Apishka_Templater_LoaderInterface')), 'foo', 'bar');
    }
