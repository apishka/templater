...
class Apishka_Templater_Tests_EnvironmentTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testExtensionsAreNotInitializedWhenRenderingACompiledTemplate()
    {
        ...
        Apishka_Templater_Tests_FilesystemHelper::removeDir($dir);
    }
    ...
    {
        $twig = new Apishka_Templater_Environment($this->getMock('Apishka_Templater_LoaderInterface'));
        $twig->addExtension(new Apishka_Templater_Tests_EnvironmentTest_Extension());
        ...
        $this->assertEquals('Apishka_Templater_Tests_EnvironmentTest_NodeVisitor', get_class($visitors[2]));
    }
    ...
    {
        $twig = new Apishka_Templater_Environment($this->getMock('Apishka_Templater_LoaderInterface'));
        $twig->addExtension(new Apishka_Templater_Tests_EnvironmentTest_ExtensionWithoutDeprecationInitRuntime());
...
class Apishka_Templater_Tests_EnvironmentTest_Extension extends Apishka_Templater_ExtensionAbstract implements Apishka_Templater_Extension_GlobalsInterface
{
    ...
    {
        return array(
            new Apishka_Templater_Tests_EnvironmentTest_TokenParser(),
        );
    }
    ...
    {
        return array(
            new Apishka_Templater_Tests_EnvironmentTest_NodeVisitor(),
        );
    }
