...
class Apishka_Templater_Tests_FileExtensionEscapingStrategyTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->assertSame($strategy, Apishka_Templater_FileExtensionEscapingStrategy::guess($filename));
    }
