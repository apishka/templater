...
class Apishka_Templater_Tests_TemplateTest extends PHPUnit_Framework_TestCase
{
    ...
    public function getAttributeExceptions()
    {
        $tests = array(
            ...
            array('{% from _self import foo %}{% macro foo(obj) %}{{ obj.missing_method() }}{% endmacro %}{{ foo(array_access) }}', 'Method "missing_method" for object "Apishka_Templater_TemplateArrayAccessObject" does not exist in "%s" at line 1', false),
