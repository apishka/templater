...
class Apishka_Templater_Tests_Cache_FilesystemTest extends PHPUnit_Framework_TestCase
{
    private $classname;
    private $directory;
    private $cache;
    ...
    protected function setUp()
    {
        ...
        $this->classname = '__Apishka_Templater_Tests_Cache_FilesystemTest_Template_' . $nonce;
        $this->directory = sys_get_temp_dir() . '/twig-test';
        $this->cache = new Apishka_Templater_Cache_Filesystem($this->directory);
    }

    protected function tearDown()
    {
        if (file_exists($this->directory)) {
            Apishka_Templater_Tests_FilesystemHelper::removeDir($this->directory);
        }
    }
    ...
    {
        $cache = new Apishka_Templater_Cache_Filesystem($input);
