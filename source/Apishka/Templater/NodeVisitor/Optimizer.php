...
/**
 * Apishka_Templater_NodeVisitor_Optimizer tries to optimizes the AST.
 *
...
class Apishka_Templater_NodeVisitor_Optimizer extends Apishka_Templater_BaseNodeVisitor
{
    ...
    private function enterOptimizeFor(Apishka_Templater_NodeAbstract $node, Apishka_Templater_Environment $env)
    {
        ...
        elseif ($node instanceof Apishka_Templater_Node_Expression_GetAttr
            && (!$node->getNode('attribute') instanceof Apishka_Templater_Node_Expression_Constant
                || 'parent' === $node->getNode('attribute')->getAttribute('value')
               )
            && (true === $this->loops[0]->getAttribute('with_loop')
                || ($node->getNode('node') instanceof Apishka_Templater_Node_Expression_Name
