 ...
 */
abstract class Apishka_Templater_Test_IntegrationTestCase extends PHPUnit_Framework_TestCase
{
    /**
     * @return string
     */
    ...
    /**
     * @return Apishka_Templater_ExtensionInterface[]
     */
    ...
    protected function doIntegrationTest($file, $message, $condition, $templates, $exception, $outputs)
    {
        ...
        foreach ($outputs as $i => $match) {
            ...
            $twig = new Apishka_Templater_Environment($loader, $config);
            ...
            try {
                ...
                if ($e instanceof Apishka_Templater_Error_Syntax) {
                    $e->setTemplateFile($file);

                    throw $e;
                }

                throw new Apishka_Templater_Error(sprintf('%s: %s', get_class($e), $e->getMessage()), -1, $file, $e);
            }
            ...
            try {
                ...
                if ($e instanceof Apishka_Templater_Error_Syntax) {
                    ...
                    $e = new Apishka_Templater_Error(sprintf('%s: %s', get_class($e), $e->getMessage()), -1, $file, $e);
                }
