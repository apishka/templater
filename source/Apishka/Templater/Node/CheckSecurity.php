...
class Apishka_Templater_Node_CheckSecurity extends Apishka_Templater_NodeAbstract
{
    ...
    public function compile(Apishka_Templater_Compiler $compiler)
    {
        ...
        $compiler
            ...
            ->write(");\n")
            ->outdent()
            ->write("} catch (Apishka_Templater_Sandbox_SecurityError \$e) {\n")
            ->indent()
            ...
            ->outdent()
            ->write("} elseif (\$e instanceof Apishka_Templater_Sandbox_SecurityNotAllowedFilterError && isset(\$filters[\$e->getFilterName()])) {\n")
            ->indent()
            ->write("\$e->setTemplateLine(\$filters[\$e->getFilterName()]);\n")
            ->outdent()
            ->write("} elseif (\$e instanceof Apishka_Templater_Sandbox_SecurityNotAllowedFunctionError && isset(\$functions[\$e->getFunctionName()])) {\n")
            ->indent()
