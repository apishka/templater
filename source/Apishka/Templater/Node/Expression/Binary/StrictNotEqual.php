...
/**
 * Apishka templater node expression binary strict not equal
 */

class Apishka_Templater_Node_Expression_Binary_StrictNotEqual extends Apishka_Templater_Node_Expression_BinaryAbstract
{
    /**
     * Get supported names
     *
