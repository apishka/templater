...
class Apishka_Templater_Node_Expression_Array extends Apishka_Templater_Node_Expression
{
    ...
    public function __construct(array $elements, $lineno)
    {
        ...
        foreach ($this->getKeyValuePairs() as $pair) {
            if ($pair['key'] instanceof Apishka_Templater_Node_Expression_Constant && ctype_digit((string) $pair['key']->getAttribute('value')) && $pair['key']->getAttribute('value') > $this->index) {
