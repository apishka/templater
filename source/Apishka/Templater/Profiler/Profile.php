 ...
 */
class Apishka_Templater_Profiler_Profile implements IteratorAggregate, Serializable
{
    const ROOT = 'ROOT';
    const BLOCK = 'block';
    ...
    public function addProfile(Apishka_Templater_Profiler_Profile $profile)
    {
