...
class Apishka_Templater_TokenStream
{
    ...
    public function next()
    {
        if (!isset($this->tokens[++$this->current])) {
            throw new Apishka_Templater_Error_Syntax('Unexpected end of template.', $this->tokens[$this->current - 1]->getLine(), $this->filename);
        }
    ...
    public function look($number = 1)
    {
        if (!isset($this->tokens[$this->current + $number])) {
            throw new Apishka_Templater_Error_Syntax('Unexpected end of template.', $this->tokens[$this->current + $number - 1]->getLine(), $this->filename);
        }
    ...
    {
        return $this->tokens[$this->current]->getType() === Apishka_Templater_Token::EOF_TYPE;
    }
